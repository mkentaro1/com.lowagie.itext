...
//                         replaces -> envelopedData = recipientInfo.getContent(certificateKey, certificateKeyProvider);
                            AsymmetricKeyParameter asymmetricKeyParameter = PrivateKeyFactory.createKey(PrivateKeyInfo.getInstance(certificateKey.getEncoded()));
                            BcRSAKeyTransEnvelopedRecipient keyTransEnvelopedRecipient = new BcRSAKeyTransEnvelopedRecipient(asymmetricKeyParameter);
                            envelopedData = recipientInfo.getContent(keyTransEnvelopedRecipient);
                            foundRecipient = true;
                        }
                    }
                }
